...
const Declined = ({job}) => {
         ...
         useEffect(() =>{
           ...
           const response = await axios.get("http://localhost:8080/getDeclinedUsers",{
       ...
       return (
        ...
        <div>
            ...
            <div className='mt-10'>
              ...
              {loading && <p className='text-mine-shaft-300 text-bold text-lg text-center'>Loading declined users taking too much time than expected  ......</p>}
