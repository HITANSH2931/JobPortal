...
const AppliedJobs = () => {
  ...
  return (
       ...
       <div className='mt-10'>
        ...
        {appliedJobs.length == 0 && <img src="noJob.webp" className='h-[30%] w-[30%] mx-auto'/>}
     
        {appliedJobs.length != 0 && <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  xl:grid-cols-4 gap-7  mx-10' >
                  ...
                  {appliedJobs.map((job,index) =>(
                      ...
                      <div key={index} className='flex flex-col gap-4 font-display bg-mine-shaft-900 rounded-lg  p-4 shadow-md shadow-mine-shaft-800 hover:border hover:border-bright-sun-300'>
                          ...
                          <div className='flex items-center gap-4'>
                              ...
                              <div className='flex flex-wrap gap-y-2.5 justify-between text-[13px] text-bright-sun-300'>
                              ...
                              <div className='flex justify-between items-center'>
                                  ...
                                  <p className='text-mine-shaft-200 text-[12px]'>Applied {getTimeAgo(job.timestamp)}</p>
